...
The extension starts an **SSE (Server-Sent Events)** server on activation.
* **Default Endpoint**: `http://localhost:6010/sse`
...
| :--- | :--- | :--- |
| `codegraph.mcp.port` | `6010` | The port for the SSE MCP server. |
